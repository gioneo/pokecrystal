...
FalknerGroup:
	...
	db  9, MURKROW,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end
...
BugsyGroup:
	...
	db 14, SPINARAK,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, LEDYBA,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
	db 16, HERACROSS,    QUICK_ATTACK, LEER, FURY_CUTTER, NO_MOVE
	db -1 ; end
...
MortyGroup:
	...
	db 21, MISDREAVUS,    HYPNOSIS, MIMIC, CURSE, NIGHT_SHADE
	db 25, GENGAR,     HYPNOSIS, SHADOW_BALL, MEAN_LOOK, DREAM_EATER
	db 23, AIPOM,    SPITE, MEAN_LOOK, MIMIC, NIGHT_SHADE
	db -1 ; end
...
PryceGroup:
	...
	db 27, CLOYSTER,       HEADBUTT, ICY_WIND, AURORA_BEAM, REST
...
JasmineGroup:
	...
	db 30, MAGNETON,  THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
...
ChuckGroup:
	...
	db 30, HITMONTOP,  HYPNOSIS, MIND_READER, SURF, DYNAMICPUNCH
	db -1 ; end
...
ClairGroup:
	...
	db 37, GYARADOS,  THUNDER_WAVE, THUNDERBOLT, SLAM, DRAGONBREATH
	db 37, RAICHU,  THUNDER_WAVE, ICE_BEAM, SLAM, DRAGONBREATH
...
WillGroup:
	...
	db 41, SLOWPOKE,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
